...
import com.zigar.user.model.LoginUser;
...
public class HomeRestController {
    ...
    Results login(@RequestBody @Validated(RequestLoginAction.class) LoginUser loginUser, HttpServletRequest httpServletRequest) throws IOException {
        ...
        User currentUser = userService.getOne(Wrappers.<User>lambdaQuery().eq(User::getUsername, loginUser.getUsername()));
        if (currentUser == null) {
    ...
    private String loginSuccessHandler(HttpServletRequest httpServletRequest, User currentUser) {
